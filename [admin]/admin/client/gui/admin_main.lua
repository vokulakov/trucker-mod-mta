...
y=y+B  aTab1.VehicleHealth	= guiCreateLabel ( 0.31, y, 0.25, 0.04, "Состояние: -", true, aTab1.Tab )
		...
		aTab1.SetDimension	= guiCreateButton ( 0.75, 0.77, 0.12, 0.05, "Измерение", true, aTab1.Tab, "setdimension" )
		guiSetFont(aTab1.SetDimension, "default-bold-small")

		aTab1.SetInterior = guiCreateButton ( 0.88, 0.77, 0.11, 0.05, "Интерьер", true, aTab1.Tab, "setinterior" )
		guiSetFont(aTab1.SetInterior, "default-bold-small")
		--aTab1.SetDimension:setData('operSounds.UI', 'ui_select')

		aTab1.VehicleFix		= guiCreateButton ( 0.75, 0.87, 0.24, 0.05, "Починить", true, aTab1.Tab, "repair" )
		...
		for i = 400, 611 do
			...
			if vehName then
				table.insert(vehicles, {text = string.format('%s [%d]', vehName, i), data = i})
			end
		end
...
--		guiSetText ( aTab1.Team, "Team: None" )
		...
		guiSetText ( aTab1.Interior, "Интерьер: -" )

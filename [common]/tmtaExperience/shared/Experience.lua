...
function Experience.givePlayer(player, amount)
    ...
    if ((expAmount) >= expToLvl) then
        ...
        triggerClientEvent(player, "tmtaExperience.onPlayerLevelUp", resourceRoot)
...
-- addCommandHandler("exp", function(player, cmd, amount)
--     Experience.givePlayer(player, amount)
-- end)
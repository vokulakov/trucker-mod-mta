...
function PointsDrawing.draw()
	...
	if not PointsDrawing.isVisible or not exports.tmtaUI:isPlayerComponentVisible("driftpoints") then
		return
	end
...
addEventHandler("onClientResourceStart", resourceRoot, function ()
	font = exports.tmtaFonts:createFontDX("RobotoBold", FONT_SIZE)
	font2 = exports.tmtaFonts:createFontDX("RobotoBold", MULTIPLIER_FONT_SIZE)
...
--[[
addEvent('rsaDriftPoint.setVisible', true)
addEventHandler('rsaDriftPoint.setVisible', root, function(state)

...
function TruckRental.onClientGUIClickBtnRent()
    ...
    triggerServerEvent('tmtaTrucker.onPlayerStartTruckRent', localPlayer, Base.getPlayerCurrentBase(), truck)
...
function TruckRental.renderExtendRentWindow(truckData, timeLeft)
    ...
    addEventHandler('onClientGUIClick', GUI.extendRent.btnRefuse, 
        function()
            ...
            showCursor(false)
            triggerServerEvent('tmtaTrucker.onPlayerRefuseRent', localPlayer)
        end, false)
    ...
    addEventHandler('onClientGUIClick', GUI.extendRent.btnExtend, 
        function()
            destroyElement(GUI.extendRent.wnd)
            showCursor(false)
            triggerServerEvent('tmtaTrucker.onPlayerExtendRent', localPlayer)
        end, false)

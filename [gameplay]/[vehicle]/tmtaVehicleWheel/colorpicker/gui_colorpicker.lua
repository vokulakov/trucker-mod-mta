...
local function drawColorPicker()
  if not isElement(isWindowActive) then
	...
	dxDrawImage(x+10, y+32, 256, 256, "colorpicker/sv.png", 0, 0, 0, color.white, colorPickerFocus)
  dxDrawImageSection(x+1+math.floor(256*color.s), y+24+(256-math.floor(256*color.v)), 16, 16, 0, 0, 16, 16, "colorpicker/cursor.png", 0, 0, 0, color.white, colorPickerFocus)
  	
  	dxDrawImage(x+288, y+32, 32, 256, "colorpicker/h.png", 0, 0, 0, color.white, colorPickerFocus)
  	dxDrawImageSection(x+280, y+24+(256-math.floor(256*color.h)), 48, 16, 16, 0, 48, 16, "colorpicker/cursor.png", 0, 0, 0, color.huecurrent, colorPickerFocus)
...
function createColorPicker(startColor, window, _isAlpha)
  ...
  if isAlpha then
    gui.alpha = guiCreateStaticImage(10, 300, 256, 15, "colorpicker/alpha.png", false, isWindowActive)
  end
  -------------

  gui.svmap = guiCreateStaticImage(10, 32, 256, 256, "colorpicker/blank.png", false, isWindowActive)
  gui.hbar = guiCreateStaticImage(288, 32, 32, 256, "colorpicker/blank.png", false, isWindowActive)
	gui.blank = guiCreateStaticImage(326, 32, 64, 64, "colorpicker/blank.png", false, isWindowActive)
  
  if isAlpha then
    gui.abar = guiCreateStaticImage(10, 300, 256, 15, "colorpicker/blank.png", false, isWindowActive)
  end
